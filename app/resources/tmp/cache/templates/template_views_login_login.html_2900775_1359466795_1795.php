...
<?php echo $this->form->create(null,array('action'=>'/','class'=>'form-horizontal')); ?>


<div class="control-group" style="margin-left:-50px">
<label class="control-label" for="inputEmail" style="margin-right:10px">Email</label>
<?php echo $this->form->email('email',array('id' => 'txtemail','class'=>'input-large','autocomplete' => 'off')); ?>
</div>
<div class="control-group" style="margin-left:-50px">
<label class="control-label" for="inputEmail" style="margin-right:10px">Password</label>
<?php echo $this->form->password('password',array('type' => 'password','id' => 'txtpassword','class' => 'input-medium')); ?>
</div>
<?php echo $this->form->button('Login',array('style'=>'margin-left: 285px; margin-top:-91px','class' => 'btn btn-primary' ,'onclick' => 'if(!validateLogin())
{
