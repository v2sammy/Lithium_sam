...
<?php echo $this->form->field('first_name',array('class'=>'input-xlarge','id' => 'txtfname','placeholder'=>'', 'autocomplete' => 'off')); ?>
<div id="fnamealertBox" class="alert alert-danger" style="display: none;"></div>

<?php echo $this->form->field('last_name',array('id' => 'txtlname' ,'placeholder'=>'' , 'autocomplete' => 'off')); ?>
<div id="lnamealertBox" class="alert alert-danger" style="display: none;"></div>

<?php echo $this->form->field('email',array('type' =>'email' ,'id' => 'txtemail' , 'autocomplete' => 'off','value'=>$_SESSION['tempuserEmail'],'readonly'=>'readonly')); ?>
<div id="emailalertBox" class="alert alert-danger" style="display: none;"></div>

<?php echo $this->form->field('password',array('type' => 'password','placeholder'=>'Minimum 6 Characters','id' => 'password', 'name'=>'password', 'onCopy' => 'return false', 'onPaste' => 'return false',
...
<?php echo $this->form->field('contact no',array('id' => 'txtcontactno', 'autocomplete' => 'off')); ?>
<div id="contactnoalertBox" class="alert alert-danger" style="display: none;"></div>

<?php echo $this->form->field('location',array('id' => 'txtlocation', 'autocomplete' => 'off')); ?>
